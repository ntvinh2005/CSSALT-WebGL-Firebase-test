...
var ASM_CONSTS = {
  3183856: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3183917: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3183981: function() {return Module.webglContextAttributes.powerPreference;},  
 3184039: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3184094: function($0) {performance.now = function() { return $0; };},  
 3184142: function($0) {performance.now = function() { return $0; };},  
 3184190: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _saveDataToFirestore(collectionName, docId, dataJson) {
...
var asmLibraryArg = {
  ...
  "saveDataToFirestore": _saveDataToFirestore,
